...
@interface RSDropdownControls ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation RSDropdownControls
...
- (void)clickBtnClicked {
    ...
    for (UIView *subview in self.superview.subviews) {
        if ([subview isKindOfClass:[RSDropdownControls class]] && subview != self) {
            RSDropdownControls *donwnSelectedView = (RSDropdownControls *)subview;
...
- (UITableView *)listTableView {
    if (!_listTableView) {
        ...
        _listTableView.backgroundColor = _listColor;
